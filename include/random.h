...
/*
 * Restoring libc rand() currently replays the saved sequence. Legitimate runs
 * stay far below this bound; rejecting larger values prevents damaged SRAM
 * from spending minutes or effectively forever in Resume.
 */
#define RNG_MAX_RESTORE_STEPS 100000U
