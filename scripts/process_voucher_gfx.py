#!/usr/bin/env python3
"""Convert the ImageGen Voucher card sheet into GBA-safe 4bpp sprites."""
...
SOURCE = ROOT / "art/imagegen/voucher_cards_imagegen_v2.png"
SHARED_PALETTE = ROOT / "graphics/alchemical_gfx.png"
OUTPUT = ROOT / "graphics/voucher_gfx.png"
FOCUS_OUTPUT = ROOT / "graphics/voucher_focus_gfx.png"
...
def main() -> None:
    ...
    palette_image = Image.open(SHARED_PALETTE).convert("P")
